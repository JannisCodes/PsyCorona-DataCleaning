...
dt0Raw <- plyr::rbind.fill(dt0RawRUG, dt0RawNYUAD, dt0RawRepNYUAD, dt0RawRepRUG, dt0RawIran)

rm(dt0RawRUG, dt0RawNYUAD, dt0RawRepNYUAD, dt0RawRepRUG, dt0RawIran)
```
...
country_dict <- list('Afghanistan' = c('Afghanistan'),
                     ...
                     'Armenia' = c('(?i)армения'),
                     'Australia' = c('australi.', 'australi..', 'austrlaia',  'austrija', '199'),
                     ...
                     'Kazakhstan' = c('(?i)каза..тан',	'^kz$',  '(?i)алматы', 'a.akh..an', 'kа.aza.stan', 'захстан', 'қазақстан', '.aza.stan', 'kaza..stan'),
                     'Kenya' = c('kenia', 'Kenia'),
                     'Kosovo' = c('(?i)Kosovo'),
                     'Kuwait' = c('الكويت'),
                     ...
                     'Philippines' = c('pllipines', 'phillippines', 'hils.', '^thephilippines$', 'philippinea', '	phillippines', '^philippines$', 'republicofthephilippines', 'Ph', 'Pilipinas', '^Phil$', 'Philippinea', '^phil$',  'filipinas', 'Philippines', 'PHILIPPINES', '206'),
...
# download contact list from qualtrics (next week this will be in one dataframe)
