...
# merge (can also be dt0Raw but for now seperate)
  dt0All <- list(dt5newVars, dt0w1, dt0w2, dt0w3, dt0w4) %>% #merge multiple dfs at once
...
country_dict <- list('Afghanistan' = c('Afghanistan'),
                     ...
                     'Philippines' = c('(?pllipines', 'p'phillippines', hils.', '^thephilippines$', 'philippinea', '	phillippines', '^philippines$', 'republicofthephilippines', 'Ph', 'Pilipinas', '^Phil$', 'Philippinea', '^phil$',  'filipinas', 'Philippines', 'PHILIPPINES', '206'),
