...
dir("data/raw data", pattern = "Baseline[ +]\\-[ +]RUG[ +]General", full.names = TRUE, ignore.case = TRUE)
...
# Import Wave 1
  ...
  dt0w3 <- read_spss(dir("data/raw data", pattern = "Wave.3", full.names = TRUE, ignore.case = TRUE)) #<-- still needs to be processed
