...
# merge (can also be dt0Raw but for now seperate)
  dt0All <- list(dt5newVars, dt0w1, dt0w2, dt0w3, dt0w4, dt0w5, dt0w6, dt0w7) %>% #merge multiple dfs at once
...
# Make contact list of all people before cutoff date
  ...
  filter(FilterPreview == 0,
         ymd_hms(dt5newVars$EndDate) < "2020-05-19 12:00:00 UTC",
...
# download contact lists from qualtrics
  CL1 <- read.csv("data/raw data/contact list/c19Recontact6_1.csv", header = T)
  CL2 <- read.csv("data/raw data/contact list/c19Recontact6_2.csv", header = T)
