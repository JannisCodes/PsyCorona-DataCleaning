...
# download contact lists from qualtrics
  CL1 <- read.csv("data/collab data/Shared/Data/raw data/contact list/c19Recontact_18_1.csv", header = T)
  CL2 <- read.csv("data/collab data/Shared/Data/raw data/contact list/c19Recontact_18_2.csv", header = T)
