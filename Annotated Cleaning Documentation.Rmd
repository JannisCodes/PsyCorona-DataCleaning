...
# Import Wave 1
  ...
  dt0w13 <- read_spss(dir("data/raw data", pattern = "Wave.13", full.names = TRUE, ignore.case = TRUE)) 
  dt0w14 <- read_spss(dir("data/raw data", pattern = "Wave.14", full.names = TRUE, ignore.case = TRUE)) 
  dt0w15 <- read_spss(dir("data/raw data", pattern = "Wave.15", full.names = TRUE, ignore.case = TRUE)) 
  dt0w16 <- read_spss(dir("data/raw data", pattern = "Wave.16", full.names = TRUE, ignore.case = TRUE)) 
  dt0w17 <- read_spss(dir("data/raw data", pattern = "Wave.17", full.names = TRUE, ignore.case = TRUE)) 
...
# merge (can also be dt0Raw but for now seperate)
  dt0All <- list(dt5newVars, dt0w1, dt0w2, dt0w3, dt0w4, dt0w5, dt0w6, dt0w7, dt0w8, dt0w9, dt0w10, dt0w11, dt0w12, dt0w13, dt0w14, dt0w15, dt0w16, dt0w17) %>% #merge multiple dfs at once
...
map <- sf::st_read(dsn="data/raw data/ZIP", layer = "ne_10m_admin_1_states_provinces")
...
# download contact lists from qualtrics
  CL1 <- read.csv("data/raw data/contact list/c19Recontact_15_1.csv", header = T)
  CL2 <- read.csv("data/raw data/contact list/c19Recontact_15_2.csv", header = T)
