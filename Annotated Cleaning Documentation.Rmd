...
# Make contact list of all people before cutoff date
  ...
  filter(FilterPreview == 0,
         ymd_hms(dt5newVars$EndDate) < "2020-05-26 12:00:00 UTC",
...
# download contact lists from qualtrics
  CL1 <- read.csv("data/raw data/contact list/c19Recontact7_1.csv", header = T)
  CL2 <- read.csv("data/raw data/contact list/c19Recontact7_2.csv", header = T)
