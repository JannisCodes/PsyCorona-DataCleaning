...
# Add the Province name to each of the data points
  dataPerProvince <- st_join(data, Provinces[c('name', 'latitude', 'longitude')])
...
# download contact lists from qualtrics
  CL1 <- read.csv("data/raw data/contact list/c19Recontact12_1.csv", header = T)
  CL2 <- read.csv("data/raw data/contact list/c19Recontact12_2.csv", header = T)
