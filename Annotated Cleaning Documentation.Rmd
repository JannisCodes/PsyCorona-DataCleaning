...
# Make contact list of all people before cutoff date
  ...
  filter(FilterPreview == 0,
         ymd_hms(dt5newVars$EndDate) < "2020-04-28 12:00:00 UTC",
...
# download contact lists from qualtrics
  CL1 <- read.csv("data/raw data/contact list/c19Recontact3_1.csv", header = T)
  CL2 <- read.csv("data/raw data/contact list/c19Recontact3_2.csv", header = T)
...
namCLUp2 <- paste0("data/cleaned data/Contact List 15001_3004 ", format(Sys.time(), format = "%F %H-%M %Z"),".csv")
