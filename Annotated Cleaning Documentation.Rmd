...
# Make contact list of all people before cutoff date
  ...
  filter(FilterPreview == 0,
         ymd#_hms(dt5newVars$EndDate) < "2020-06-07 11:00:00 UTC",
   # filter not needed anymore       ICRec_1_TEXT!="") %>% #chdyr::distinct(ICRec_1_TEXT, .keep_all = TRUE) %>%
...
# download contact lists from qualtrics
  CL1 <- read.csv("data/raw data/contact list/c19Recontact9_111_1.", header = T)
  CL2 <- read.csv("data/raw data/contact list/c19Recontact9_211_2.", header = T)
