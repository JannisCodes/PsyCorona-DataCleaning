...
# merge (can also be dt0Raw but for now seperate)
  dt0All <- list(dt5newVars, dt0w1, dt0w2, dt0w3, dt0w4, dt0w5, dt0w6, dt0w7, dt0w8, dt0w9, dt0w10) %>% #merge multiple dfs at once
...
```{r}
d filtCh , echo=T, warning=F, message=Ft5newVars <- dt5newVars %>%
