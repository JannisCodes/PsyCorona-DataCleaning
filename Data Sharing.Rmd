...
# Import Qualtrics Survey Data (new but no localization)
  dtAll <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All 2020-12-20 18-01 CET_noLocalization.sav")
  # dtAllLocal <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All 2020-10-25 12-22 CET Region Only.sav") #load old region
  # dtAll <- dplyr::left_join(dtAll, dtAllLocal, by = "ResponseId") # merge
  rm(dtAllLocal) 
# Import Qualtrics Survey Data
  # dtAll <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All 2020-10-25 12-22 CET.sav")
...
# Import Harmonized Data (new but no localization)
  dtAllHarmo <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All Harmonized 2020-12-20 18-01 CET_noLocalization.sav")
# Import Harmonized Data
  # dtAllHarmo <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All Harmonized 2020-10-25 12-22 CET.sav")
...
# Import Request sheet
  ...
  dtReqMeta <- dtReq[c(307:nrow(dtReq)),]
