...
# Import Qualtrics Survey Data (new but no localization)
  dtAll <- haven::read_spss("data/collab data/Shared/Data/cleaned data/Psycorona Baseline cleaned - All 2021-02-26 11-17 CET_noLocalization.sav")
...
# Import Harmonized Data (new but no localization)
  dtAllHarmo <- haven::read_spss("data/collab data/Shared/Data/cleaned data/Psycorona Baseline cleaned - All Harmonized 2021-02-26 11-17 CET_noLocalization.sav")
...
# Import Request sheet
  ...
  dtReqMeta <- dtReq[c(370:nrow(dtReq)),]
...
# export if needed
write.csv(tmp,'data/cleaned data/respRatePerCtry+source.csv')
