...
# Import Qualtrics Survey Data
  ...
  dtAll <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All 2020-05-20 19-59 CEST .sav")
  dtAll$representative <- dtAll$source
  # recode source so not identifiable
    dtAll$source <- dplyr::recode(dtAll$source, "Fly" = 1, "HNATD" = 2, "Iran" = 3, "NYU-AD" = 4, "RUG" = 5, 
                                  "Rep NYU-AD" = 6, "Rep RUG" = 7)
