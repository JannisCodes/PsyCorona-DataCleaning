...
# Import Qualtrics Survey Data
  ...
  dtAll <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All 2020-06-09 14-53 CEST.sav")
...
tmp2 <- dtAll[dtAll$coded_country == "China",]
tmp2 <- dtAll[dtAll$language == "Chinese (Simplified)" | dtAll$language == "Chinese (Traditional)",]
table(tmp2$source, tmp2$language)
table(tmp2$source, tmp2$language)
table(tmp2$source, tmp2$coded_country)
