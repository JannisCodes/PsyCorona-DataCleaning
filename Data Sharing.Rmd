...
# Import Qualtrics Survey Data (new but no localization)
  dtAll <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All 2020-12-28 17-30 CET_noLocalization.sav")
...
# Import Harmonized Data (new but no localization)
  dtAllHarmo <- read_spss("data/cleaned data/Psycorona Baseline cleaned - All Harmonized 2020-12-28 17-30 CET_noLocalization.sav")
...
# Import Request sheet
  ...
  dtReqMeta <- dtReq[c(350:nrow(dtReq)),]
